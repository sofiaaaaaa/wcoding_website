...
LOCAL_APPS = [
    # custom users app
    'wcoding_website.users.apps.UsersConfig',
...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'wcoding_website.contrib.sites.migrations'
}
...
ACCOUNT_ADAPTER = 'wcoding_website.users.adapters.AccountAdapter'
SOCIALACCOUNT_ADAPTER = 'wcoding_website.users.adapters.SocialAccountAdapter'
